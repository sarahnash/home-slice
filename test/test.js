...
function createHTML(res) {
  if (res) {
    return `<div class="card bg-dark text-white"><img class="card-img" src="${res.image_url}" alt="Card image"><div class="card-img-overlay"><h5 class="card-title">${res.name}</h5><p class="card-text">${res.price}</p></div></div>`}
}

var assert = require('assert')
describe('Rendering', function() {
  it('should dynamically generate HTML', function () {
    var dataObject = {image_url: 'www.banana.com', name: 'oakman', price: 100}
